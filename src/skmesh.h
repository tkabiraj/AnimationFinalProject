...
private:
    ...
    float time_blend_start_from = -1;
    float time_blend_start_to = -1;
...
#define NUM_BONES_PER_VEREX 4
        ...
        void ReadNodeHeirarchy(const aiNode* pNode, const mat4& ParentTransform, double AnimationTime, double AnimationTime_to, double blendfactor);
